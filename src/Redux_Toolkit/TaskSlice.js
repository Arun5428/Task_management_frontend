...
export const fetchUsersTasks=createAsyncThunk("task/fetchUsersTasks",
    async({status})=>{
        ...
        try{
            ...
            console.log("fetch Users task data",data);
            return data
...
const taskSlice=createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        .addCase(updateTask.fulfilled,(state,action)=>{
            const updatedStasks=action.payload
            state.loading=false;
        
        state.tasks=state.tasks.map((task)=>task.id===updatedStasks.id?{...task,...updatedStasks}:task);
